...
//            randomTest 100 100
//        let x = 1
//        let seqInfinite = (fun x -> x) |> Seq.initInfinite |> Seq.truncate 100 |> Seq.toList
//        printfn "%A" seqInfinite
//        printfn "%A" ( |> Seq.truncate 10 |> Seq.toList)
//        printfn "%A" (Primes.naturalSeries |> Seq.toList)
        printfn "%A" (Primes.infinite |> Seq.truncate 100 |> Seq.toList)
        0
